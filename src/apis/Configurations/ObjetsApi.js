...
// GET
const GET_SETTING_API = HOST + "api/v1/config/objet/list/false"
// ADD
const ADD_SETTING_API = HOST + "api/v1/config/objet/add"
// PUT
const UPDATE_SETTING_API = HOST + "api/v1/config/objet/id/update"
// DELETE
const DELETE_SETTING_API = HOST + "api/v1/config/objet/id/delete"
