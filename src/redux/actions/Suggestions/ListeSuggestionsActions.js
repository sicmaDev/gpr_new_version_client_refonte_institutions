...
export const suggestionListErrors = (errors) => {
    return {
        type: 'SUGGESTION_LIST_ERRORS',
        payload: errors,
...
export const idChanged = (id) => {
    return {
        type: 'SUGGESTION_LIST_ID_CHANGED',
        payload: id,
        info: 'This action is used to ...'
    }
};
export const firstnameChanged = (firstname) => {
    return {
        type: 'SUGGESTION_LIST_FIRSTNAME_CHANGED',
        payload: firstname,
        info: 'This action is used to ...'
    }
};
export const lastnameChanged = (lastname) => {
    return {
        type: 'SUGGESTION_LIST_LASTNAME_CHANGED',
        payload: lastname,
        info: 'This action is used to ...'
    }
};
export const addressChanged = (address) => {
    return {
        type: 'SUGGESTION_LIST_ADDRESS_CHANGED',
        payload: address,
        info: 'This action is used to ...'
    }
};
export const phoneChanged = (phone) => {
    return {
        type: 'SUGGESTION_LIST_PHONE_CHANGED',
        payload: phone,
        info: 'This action is used to ...'
    }
};
export const genderChanged = (gender) => {
    return {
        type: 'SUGGESTION_LIST_GENDER_CHANGED',
        payload: gender,
        info: 'This action is used to ...'
    }
};
export const languageChanged = (language) => {
    return {
        type: 'SUGGESTION_LIST_LANGUAGE_CHANGED',
        payload: language,
        info: 'This action is used to ...'
    }
};
export const dossierimfChanged = (dossierimf) => {
    return {
        type: 'SUGGESTION_LIST_DOSSIERIMF_CHANGED',
        payload: dossierimf,
        info: 'This action is used to ...'
    }
};
...
export const collectChanged = (collect) => {
    return {
        type: 'SUGGESTION_LIST_COLLECT_CHANGED',
        payload: collect,
        info: 'This action is used to ...'
    }
};
export const subjectChanged = (subject) => {
    return {
        type: 'SUGGESTION_LIST_SUBJECT_CHANGED',
        payload: subject,
        info: 'This action is used to ...'
    }
};
export const productChanged = (product) => {
    return {
        type: 'SUGGESTION_LIST_PRODUCT_CHANGED',
        payload: product,
        info: 'This action is used to ...'
    }
};
export const unitChanged = (unit) => {
    return {
        type: 'SUGGESTION_LIST_UNIT_CHANGED',
        payload: unit,
        info: 'This action is used to ...'
    }
};
export const contentChanged = (content) => {
    return {
        type: 'SUGGESTION_LIST_CONTENT_CHANGED',
        payload: content,
        info: 'This action is used to ...'
    }
};
...
export const createdAtChanged = (createdAt) => {
    return {
        type: 'SUGGESTION_LIST_CREATED_AT_CHANGED',
        payload: createdAt,
        info: 'This action is used to ...'
    }
};
export const createdByChanged = (createdBy) => {
    return {
        type: 'SUGGESTION_LIST_CREATED_BY_CHANGED',
        payload: createdBy,
        info: 'This action is used to ...'
    }
};
export const handledAtChanged = (handledAt) => {
    return {
        type: 'SUGGESTION_LIST_HANDLED_AT_CHANGED',
        payload: handledAt,
        info: 'This action is used to ...'
    }
};
export const handledByChanged = (handledBy) => {
    return {
        type: 'SUGGESTION_LIST_HANDLED_BY_CHANGED',
        payload: handledBy,
        info: 'This action is used to ...'
    }
};
export const resolvedAtChanged = (resolvedAt) => {
    return {
        type: 'SUGGESTION_LIST_RESOLVED_AT_CHANGED',
        payload: resolvedAt,
        info: 'This action is used to ...'
    }
};
export const resolvedByChanged = (resolvedBy) => {
    return {
        type: 'SUGGESTION_LIST_RESOLVED_BY_CHANGED',
        payload: resolvedBy,
        info: 'This action is used to ...'
    }
};
