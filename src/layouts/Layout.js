            ...
            {isLoading ?
                <>
                    <div style={{ width: "100vw", height: "100vh", backgroundColor: "#005081", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
                        ...
                        <div style={{ fontSize: "18px", fontWeight: 800, color: "white" }}>En cours de chargement ... </div>
                        <div style={{ fontSize: "13px", fontWeight: 300, color: "gray" }}>Patientez s'il vous plait </div>
                    </div>
                </> :
               (props.isAuthenticated ? <Template2 /> : <Login />)
            }
        </>
    )
}
